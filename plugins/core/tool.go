...
func SwProperties() (props []*commonv3.KeyStringValuePair) {
	labels := make(map[string]string)
	properties := os.Getenv("SW_INSTANCE_PROPERTIES_JSON")
	if len(properties) != 0 {
		if err := json.Unmarshal([]byte(properties), &labels); err != nil {
			return nil
		}
...
func buildOSInfo() (props []*commonv3.KeyStringValuePair) {
	...
	//if cluster != "" {
	//	k8sCluster := &commonv3.KeyStringValuePair{
	//		Key:   "k8s_cluster",
	//		Value: cluster,
	//	}
	//	props = append(props, k8sCluster)
	//}
	//
	//namespace := os.Getenv("POD_NAMESPACE")
	//if namespace != "" {
	//	k8sNamespace := &commonv3.KeyStringValuePair{
	//		Key:   "k8s_namespace",
	//		Value: namespace,
	//	}
	//	props = append(props, k8sNamespace)
	//}
	//
	//podUid := os.Getenv("POD_UID")
	//if podUid != "" {
	//	k8sPodUid := &commonv3.KeyStringValuePair{
	//		Key:   "k8s_pod_uid",
	//		Value: podUid,
	//	}
	//	props = append(props, k8sPodUid)
	//}
	//
	//hostIp := os.Getenv("NODE_IP")
	//if hostIp != "" {
	//	k8sHostIp := &commonv3.KeyStringValuePair{
	//		Key:   "host_ip",
	//		Value: hostIp,
	//	}
	//	props = append(props, k8sHostIp)
	//}
	//
	//hostName := os.Getenv("NODE_NAME")
	//if hostName != "" {
	//	k8sHostName := &commonv3.KeyStringValuePair{
	//		Key:   "host_name",
	//		Value: hostName,
	//	}
	//	props = append(props, k8sHostName)
	//}

	swProperties := SwProperties()
	if len(swProperties) != 0 {
		props = append(props, swProperties...)
	}
